    ...
    <div className="ptta-root min-h-screen bg-page text-ink pb-52 md:pb-56">
      ...
      >
        <motion.button
          ...
          className="ptta-cta-halo pointer-events-auto w-full px-6 py-4 rounded-full bg-accent text-black text-base font-sans font-normal focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
