...
export function ProcessingStage({
  ...
  // Aspect ratio detected from the loaded image so the frame can size itself
  // to the available area without clipping the painting on short viewports.
  // Default to a typical portrait painting so the first frame isn't 0x0.
        ...
        <div className="flex-1 min-h-0 px-4 sm:px-6 py-2 sm:py-4">
          ...
          >
            <div
              ...
              style={{
                // Largest aspect-correct rectangle that fits the container.
                // min() picks whichever dimension is the binding constraint.
